...
const BasicModalMaintenanceData = ({name}) => {
  ...
  return (
    <>
        <Button onClick={handleOpen} variant='contained' style={{backgroundColor:'#FFFAFA' , width: '100%', color:'#000', margin: '1vh 0'}}>{name}</Button>
        <Modal
            open={open}
            onClose={handleClose}
...
export default BasicModalMaintenanceData